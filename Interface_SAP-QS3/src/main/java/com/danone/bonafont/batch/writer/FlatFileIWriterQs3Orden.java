 ...
 */
public class FlatFileIWriterQs3Orden extends FlatFileItemWriter<Qs3Orden> {

	private static final Logger LOG = Logger.getLogger(FlatFileIWriterQs3Orden.class);
